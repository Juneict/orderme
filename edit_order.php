<?php 
   ...
   if(isset($_POST['edit_todo'])){
       ...
       $edit_due =$_POST['due'];
      $query ="UPDATE `orders` SET `name`='$edit_name',`phone`='$edit_phone',`product`='$edit_product',`price`='$edit_price',`due`='$edit_due',`order_date`=now() WHERE id=$e_id";
      $update  =mysqli_query($conn,$query);
        if(!$update){
        die("Failed");
        }else{
       header("location:dashboard.php?order-updated");
        }
   }
?>
<!DOCTYPE html>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="text" name="product" placeholder="ပစ္စည်း အမျိုးအစား" value="<?php echo $data['product'];?>">
                            </div>
                            <div class="form-group">
