<?php 
    ...
    if($_SERVER['REQUEST_METHOD'] =='POST'){
        ...
        $due =$_POST['due'];
        //$order_date =now();
        $sql = "INSERT INTO `orders`(`name`, `phone`, `product`,`price`, `due`, `order_date`) VALUES ('$name','$phone','$product','$price','$due',now())";
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
                            ...
                            <div class="form-group">
                                <input class="form-control" type="text" name="product" placeholder="ပစ္စည်း အမျိုးအစား">
                            </div>
                            <div class="form-group">
